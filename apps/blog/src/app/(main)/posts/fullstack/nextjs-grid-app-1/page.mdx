...
export const metadata = frontmatter({
  title: 'Next.js 서버 컴포넌트와 서버 액션으로 풀스택 그리드 앱 시작하기 (1편)',
  description:
    '풀스택 데이터 그리드 앱을 만드는 첫 단계입니다. Next.js 프로젝트를 생성하고, 서버 컴포넌트와 서버 액션이 각각 무엇을 담당하는지 정리합니다.',
  seriesId: 'fullstack',
...
[다음 포스트](/posts/fullstack/nextjs-grid-app-2)에선 Prisma ORM을 설치하고 앞서 만든 서버사이드의 더미 코드를 구현해보려고 합니다.
