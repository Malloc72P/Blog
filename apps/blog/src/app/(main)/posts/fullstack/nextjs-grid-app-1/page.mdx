...
export const metadata = frontmatter({
  title: 'Next.js와 PrismaORM, 그리고 AG Grid로 풀스택 데이터 그리드 앱 만들기 1편',
  description:
    'Next.js와 PrismaORM, 그리고 AG Grid를 사용해서 풀스택 데이터 그리드 앱을 만드는 방법에 대해 설명합니다. 초보자도 따라할 수 있도록 가이드를 제공합니다. 해당 편에선 Next.js에 대한 간단한 소개와 실습을 진행합니다.',
  seriesId: 'fullstack',
...
- 클라이언트 컴포넌트에서 전달받은 데이터 렌더링(OrderGrid)
